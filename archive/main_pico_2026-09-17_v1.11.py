# main.py — KROMKA STANSIYASI KONTROLLERI  (TZ v1.2, proshivka v1.11)
#
...
if CHOP:
    print("=" * 50)
    print("  KROMKA STANSIYASI KONTROLLERI  v1.11")
...
while True:
    ...
    while navbat:
        ...
        if e:
            ...
            if kanal == 1:
                d1_tugadi(time.ticks_add(t, -d), m, d)   # m — orqa qirra lahzasi
            else:
