# main.py — KROMKA STANSIYASI KONTROLLERI  (TZ v1.2, proshivka v1.12)
#
...
#   SET D=.. V10=.. V18=.. K1=.. K2=.. B1=.. B2=.. C=.. TD=.. AO=0|1
...
# TOVUSH: bitta baland "tut" ohangi. 2–3 kHz — quloq eng sezgir va kichik
# dinamik eng baland chiqaradigan oraliq. Pastroq/balandroq kerak bo'lsa —
...
def buyruq_tekshir():
    ...
    if cmd == 'QR':
        ...
        yubor({'ev': 'kal', 'D': KAL['D'], 'V10': KAL['V10'], 'V18': KAL['V18'],
               'K1': KAL['K1'], 'K2': KAL['K2'], 'B1': KAL['B1'], 'B2': KAL['B2'],
               'C': KAL['C'], 'TD': KAL['TD'],
               'AO': KAL['AO']})
...
if CHOP:
    print("=" * 50)
    print("  KROMKA STANSIYASI KONTROLLERI  v1.12")
