...
{"ev":"tiqilish","sabab":"birga_otdi|vaqt_mos_emas","n":2,"L2":1100.0,"L1":[500.0,600.0]}   ← v1.16: D1/D2 vaqtlari bir detalga to'g'ri kelmadi, o'lchov chiqarilmaydi
...
- **Tiqilish va juftlashni tekshirish (v1.16, 2026-09-20 shikoyati bo'yicha)**: ilgari navbat boshidagi yozuv `d2_kutish_ms` (10 m/min da ~23 s) dan uzoq kutsa TASHLANARDI va FAQAT1 chiqardi. Detallar tiqilib qolganda shu tashlash navbatni bir qadam siljitardi — keyin kelgan har bir D2 o'lchovi BOSHQA detalning D1 yozuvi bilan juftlanib, o'lcham butunlay noto'g'ri chiqardi (MES da 594 mm o'rniga 1259.9, 606 o'rniga 1390.1). Endi:
  - Kutish muddati `KUT_KARRA=5` karra uzun (~78 s) va faqat stanok ishlayotganda, hech bir datchik ostida detal turmaganda sanaladi.
  - D2 detalni o'tkazganda **uzunliklar solishtiriladi** (`_yaqin`: 25% yoki kamida 30 mm, kichik uzunlikdan): navbat boshi mos kelsa — juft; bir necha yozuv YIG'INDISI mos kelsa — detallar **birga o'tgan** (`tiqilish` hodisasi, o'lchov chiqmaydi); keyingi yozuv mos kelsa — oldingilari yo'qolgan (FAQAT1); hech biri mos kelmasa — `tiqilish` (`vaqt_mos_emas`).
